...
df.head()
df["overall"].mean() #Hiçbir işlem yapmadan alınan ortalamadır
...
#Sadece kullanacak olduğumuz kolonları alıyoruz
...
###################################################
# Gelen pozitif ve negatşf yorumlara göre güven aralığı oluşturalım ve bu güven aralığı içerisindeki min değeri oluşturan değer oluşturalım
#  Min değeri alarak şansa bırakmadan yapalım diyor
...
df.sort_values("wilson_lower_bound", ascending=False).head(20)
#wlb social proof etkisini de içeren önemli bir değerdir.
