...
df_control = pd.read_excel("Measurement_Problems/datasets/ab_testing.xlsx",sheet_name="Control Group")
df_control.head()


df_test = pd.read_excel("Measurement_Problems/datasets/ab_testing.xlsx",sheet_name="Test Group")
df_test.head()
